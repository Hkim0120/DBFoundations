...
-- 2017-01-01,HyunguKim,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_HyunguKim')
	 Begin 
	  Alter Database [Assignment06DB_HyunguKim] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_HyunguKim;
	 End
	Create Database Assignment06DB_HyunguKim;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_HyunguKim;
